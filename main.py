...
final_result = right_number + left_number

if final_result < 60:
    print(f"Your score is {right_number}{left_number}, you are alright together.")
else:
    print(f"Your score is {right_number}{left_number}")
